...
const projects = [
  ...
  { title: { pt: "Nova Notes", es: "Nova Notes", en: "Nova Notes" }, category: { pt: "Produto digital / E-commerce", es: "Producto digital / E-commerce", en: "Digital product / E-commerce" }, year: { pt: "Projeto autoral", es: "Proyecto propio", en: "Author project" }, image: "https://images.unsplash.com/photo-1517842645767-c639042777db?auto=format&fit=crop&w=1000&q=85", url: "https://novanotes-gpa2zmyq.manus.space/", summary: { pt: "E-commerce autoral de papelaria digital com cadernos, planners, stickers, kits e briefing para produtos personalizados.", es: "E-commerce propio de papelería digital con cuadernos, planners, stickers, kits y briefing para productos personalizados.", en: "Author e-commerce for digital stationery with notebooks, planners, stickers, bundles and custom product briefs." }, size: "wide" },
];
